...
<!-- Descrição do projeto + ícone de foguete -->
<p align="center" style="font-size: 18px; margin-bottom: 30px;">
  🎉 Sem necessidade de instalação ou configuração — clique duplo para começar a usar.<br/>
  🌸 Interface limpa e elegante, operação fluida.<br/>
  🚀 Atalhos de teclado poderosos para aumentar a eficiência do trabalho.
</p>

<p align="center" style="font-size: 16px; color: #666; margin-bottom: 20px;">
  Uma ferramenta de contagem regressiva ultraleve para Windows com função Pomodoro,<br/>
  interface transparente e opções ricas de personalização,<br/>
  ocupa apenas alguns MB de memória e consome quase nenhum recurso de CPU,<br/>
  ajudando você a gerenciar o tempo no Windows de forma elegante.
</p>

<p align="center"><a href="https://vladelaina.github.io/Catime/">Site oficial</a> · <a href="https://vladelaina.github.io/Catime/guide.html">Guia</a> · <a href="https://vladelaina.github.io/Catime/about.html">Sobre</a> · <a href="https://github.com/users/vladelaina/projects/2/views/1">Quadro do projeto</a> · <a href="https://github.com/vladelaina/Catime/issues">Feedback</a></p>
...
<!-- Links da comunidade -->
<div align="center" style="margin-bottom: 30px;">
  👋 Junte-se à nossa comunidade no 
...
## [🌟 Funcionalidades](https://vladelaina.github.io/Catime/#core-features)

- **Design minimalista**: interface transparente, clique através, arrastar e redimensionar livremente, sem interface de configurações gráficas complexas, não parece um aplicativo extra em execução.
- **Temporização flexível**: predefinições rápidas, entrada de tempo personalizada, exibição do horário atual (formato 12/24 horas), contagem regressiva, contagem progressiva, Pomodoro.
- **Ações de timeout**: exibir mensagem, mostrar horário atual, contagem progressiva, bloquear tela, abrir arquivos/aplicativos, abrir sites, desligar, reiniciar.
- **Personalização rica**: 13 fontes, 15 cores predefinidas, suporte a valores de cores personalizados, seleção de paleta de cores, visualização em tempo real.

## 📥 Download

[<img src="https://get.microsoft.com/images/pt-br%20dark.svg" alt="Obter da Microsoft" height="104">](https://apps.microsoft.com/detail/9n3mzdf1z34v?referrer=appbadge&launch=true&mode=full)
#### 🪟 Winget

#### 💾 Download manual

Baixe a versão mais recente no [GitHub Releases](https://github.com/vladelaina/Catime/releases/latest).

## [💡 Casos de uso](https://vladelaina.github.io/Catime/#use-cases)

- 👔 Contagem regressiva para o fim do trabalho
- 🍅 Técnica Pomodoro
- 🎮 Rastreamento de tempo em jogos
- ⏰ Abertura programada:
  - 🌐 Sites
  - 💻 Aplicativos
  - 📄 Arquivos
  - 📝 Scripts em lote
  - 🔄 Desligamento/reinicialização programada
- 📊 Contagem regressiva para apresentações
- 🕰️ Relógio de mesa
- ⏱️ Temporizador progressivo/regressivo

## [📑 Guia do usuário](https://vladelaina.github.io/Catime/guide)

- **Clique com o botão esquerdo no ícone da bandeja**: definir **tempo**
- **Clique com o botão direito no ícone da bandeja**: abrir **menu**
- **Modo de edição**: arrastar para ajustar a posição, roda do mouse para ajustar o tamanho, 🖱️ clique direito para sair do modo de edição

> O arquivo de configuração é salvo em `C:\Users\<username>\AppData\Local\Catime\config.ini`

## 🛠️ [Construir a partir do código-fonte](https://www.bilibili.com/video/BV1H97LzVEee)
...
#### 📦 2.1 Instalar [MinGW Build](https://github.com/niXman/mingw-builds-binaries/releases/latest)

1. **Descompactar MinGW para um local específico**
   Exemplo: descompacte `x86_64-<versão>-release-win32-seh-ucrt-rtv<num>-rev<num>.7z` para:
...
2. **Configurar a variável de ambiente PATH**
   ...
   * Encontre a variável `Path` nas **variáveis do sistema**, clique em "Editar"
...
3. **Verificar a instalação**
   ...
   Abra o Prompt de Comando (Win + R → digite `cmd` → Enter), digite:
...
## [✨ Agradecimentos](https://vladelaina.github.io/Catime/#thanks)

Agradecimentos especiais aos seguintes colaboradores (em ordem cronológica):
<table>
  <tbody>
    <tr>
...
Este projeto é lançado sob a licença de código aberto Apache License 2.0.

Declaração de direitos autorais do ícone:
- O ícone do software foi criado por [猫屋敷梨梨Official](https://space.bilibili.com/26087398), todos os direitos reservados. Não pode ser usado para fins comerciais sem autorização explícita do autor original.
...
- Autor: [猫屋敷梨梨Official](https://space.bilibili.com/26087398)
  - Link do papel de parede dinâmico: [Wallpaper Engine](https://steamcommunity.com/sharedfiles/filedetails/?id=3171487185)
